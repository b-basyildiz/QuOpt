...
do
    ...
    python fullControl.py $quditType $gateType $couplingType $segmentNum $drivesType $anharmonicity $crossTalk $g $staggering $randomSeedCount $points $iterationCount $maxDriveStrength $maxTime $i
